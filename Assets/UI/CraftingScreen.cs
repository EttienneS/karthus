...
public class CraftingScreen : MonoBehaviour
{
    ...
    private void Scale()
    {
        ...
        QueuePanel.GetComponent<RectTransform>().SetSizeWithCurrentAnchors(RectTransform.Axis.Vertical, FactionController.Factions[FactionConstants.Player].GetTaskByOriginator(_craftSource.GetGameId()).Count() * 70f);
